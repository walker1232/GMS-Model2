...
<!-- react-text: 266 -->(주)야놀자<!-- /react-text --><i data-reactid="267"></i><!-- react-text: 268 -->대표이사: 이수진<!-- /react-text --><i data-reactid="269"></i>
		...
		<!-- react-text: 281 -->관광사업자 등록번호: 제2016-31호<!-- /react-text --><i data-reactid="282"></i><!-- react-text: 283 -->호스팅 서비스 제공자: (주)야놀자<!-- /react-text --><p data-reactid="284">(주)야놀자는 통신판매중개자로서, 통신판매의 당사자가 아니라는 사실을 고지하며 상품의 예약, 이용 및 환불 등과 관련한 의무와 책임은 각 판매자에게 있습니다.</p>